            ...
            {selectedUserData && (
              <>
                <div className='container max-w-[650px] w-full'>
                  ...
                  <h2 className='text-3xl font-bold'>{selectedUserData.usercode}</h2>
                    ...
                    <button
                      ...
                      className={`${
                        activeTab === 'contact'
                          ...
                          : 'bg-white text-black'
                      } px-2 py-[2px] text-sm border rounded-2xl`}
                    >
                      Contact Details
                    </button>
                    <button
                  ...
                  {activeTab === 'contact' && (
                    <div className='max-w-[400px] py-5 px-10 w-full'>
                      <div className='flex gap-20'>
                        <p>Email</p>
                        <p>{/* Display email from selectedUserData */}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {activeTab === 'professional' && (
                    <div className='max-w-[400px] py-5 px-10 w-full'>
                      {/* Display professional details from selectedUserData */}
                      Professional Details
                    </div>
                  )}

                  {activeTab === 'history' && (
                    <div className='max-w-[400px] py-2 px-10 w-full'>
                      Jack Caspino
                    </div>
                  )}
                </div>
